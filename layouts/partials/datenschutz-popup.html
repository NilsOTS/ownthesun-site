...
<head>
  <meta charset="UTF-8">
  <title>Datenschutzerklärung | Own The Sun</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <style>
    body { font-family: Arial, sans-serif; max-width: 800px; margin: 40px auto; color: #212121; background: #fff; }
    h1 { color: #c79d22; }
    h2 { margin-top: 32px; }
    a { color: #2B3C70; }
    .small { font-size: 0.96em; color: #666; }
  </style>
</head>
<body>
  ...
  <ul>
    <li>IP-Adresse (gekürzt, keine dauerhafte Speicherung)</li>
    <li>Datum, Uhrzeit, abgerufene Seite/URL</li>
    <li>Referrer-URL</li>
    <li>Browser, Betriebssystem, Provider</li>
  </ul>
  <p>Zwecke: Betrieb, Sicherheit, Stabilität. Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO.</p>
  <strong>b) Kontaktformular:</strong>
  <ul>
    <li>Name, E-Mail, Telefonnummer, Nachricht, IP-Adresse, Zeitstempel</li>
  </ul>
  <p>Zwecke: Bearbeitung Ihrer Anfrage. Rechtsgrundlage: Art. 6 Abs. 1 lit. b und a DSGVO.</p>
  <strong>c) E-Mail-Kontakt:</strong>
  <ul>
